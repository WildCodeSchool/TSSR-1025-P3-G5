...
![alt text](Ressources/messagerie-users3.png)

## Depuis iRedmail/admin

* Ajouter un nom de domaine comme "billu.com"  

![alt text](Ressources/messagerie-users8.png)

* Créer des utilisateurs rattachés à ce domaine

![alt text](Ressources/messagerie-users7.png)

* Possible de définir des utilisateurs "Administrateurs"

![alt text](Ressources/messagerie-users6.png)

## Utilisation depuis le webmail  

* Connexion avec les logins précédemment créés

![alt text](Ressources/messagerie-users5.png)
![alt text](Ressources/messagerie-users4.png)
